...
public class SignupPanel extends JPanel{
	...
	private Image backgroundImage = new ImageIcon(getClass().getResource("../Images2/Arch.png")).getImage();
...
//		add(lblNewLabel);
		...
		tfname.setBounds(200,230,200,30);
		add(tfname);
		tfname.setColumns(10);
		
		tfpw = new JPasswordField();
		tfpw.setBounds(200,310,200,30);
		add(tfpw);
		
		tfrpw = new JPasswordField();
		tfrpw.setBounds(200,390,200,30);
		add(tfrpw);
		
		btCreate = new JButton("\uC644\uB8CC");
		btCreate.setBounds(125,500,105,27);
		add(btCreate);
		
		btCancel = new JButton("\uCDE8\uC18C");
		btCancel.setBounds(320, 500, 105, 27);
		add(btCancel);
...
//		bg.add(rbdisAgree);
		...
		label_1.setBounds(83, 310, 105, 18);
		add(label_1);
		...
		label_2.setBounds(48, 390, 139, 18);
		add(label_2);
